...
import {IInvestorSalePool} from "./interfaces/IInvestorSalePool.sol";

contract InvestorSalePool is IInvestorSalePool, Ownable {
    ...
    function BuyWithUSDT(uint256 _amount) external {
        ...
        uint256 amountToRedemption = _amount / 2;
        USDT.safeTransferFrom(msg.sender, address(this), _amount);
        USDT.transfer(address(redemptionPool), amountToRedemption);
